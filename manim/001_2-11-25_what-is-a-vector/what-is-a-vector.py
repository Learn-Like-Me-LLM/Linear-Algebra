...
def create_debug_rect(mobject, color=RED):
...
def titleScene(self, debug=False):
    ...
    title_container_rect = create_debug_rect(title_container, RED)
...
def exampleScene(self, debug=False):
    ...
    complete_example_rect = create_debug_rect(complete_example, RED)
...
def makePlane(self, debug=False):
    ...
    if debug:
        plane_container_rect = create_debug_rect(plane_container, RED)
...
class WhatIsAVector(Scene):
    def construct(self):
        ...
        if debug:
            explanation_container_rect = create_debug_rect(explanation_container, BLUE)
